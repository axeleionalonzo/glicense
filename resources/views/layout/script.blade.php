...
<!-- Firebase -->
<script src="{{ asset('js/services/firebase.js') }}"></script>
<!-- Angular + FireBase - ish -->
<script src="{{ asset('js/services/angularfire.min.js') }}"></script>
...
<script src="{{ asset('js/services/FileSaver.js') }}"></script>
